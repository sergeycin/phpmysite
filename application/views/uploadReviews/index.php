...
<body>
  ...
  <section class="content container">
    ...
    <form action="/uploadReviews/create" method="POST" enctype="multipart/form-data">
        <div class="input-group">
            ...
            <div class="input-group-append">
                <button class="btn btn-outline-primary" type="submit" id="uploadInputBtn" style="color: limegreen; background-color: black; border-color: limegreen;">Отправить файл</button>
            </div>
        </div>
    </form>
